                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('roles.store') }}">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <x-input-label for="name" :value="__('Assign Permissions to this Role')" />
                                <hr>
                                        ...
                                        @foreach ($permissions as $permission)
                                            <div class="mt-1">
                                                <label for="permission-{{ $permission->id }}">
                                                    <input type="checkbox" class="rounded" name="permissions[]"
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <table class="min-w-full bg-white dark:bg-gray-800 border-collapse">
                        <thead class="bg-gray-100 dark:bg-gray-700 border-b">
                            <tr>
                                <th class="py-2 px-4 border text-left dark:text-gray-300">Roles</th>
                                <th class="py-2 px-4 border text-left dark:text-gray-300">Assigned Permissions</th>
                                ...
                                @foreach ($roles as $role)
                                    <tr>
                                        ...
                                        <td class="py-2 px-4 border dark:border-gray-700">
                                            {{ $role->permissions->pluck('name')->join(', ') }}</td>
                                        <td class="py-2 px-4 border dark:border-gray-700">
